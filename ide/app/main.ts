...
window["MacroWidgetPromise"] = <Promise<any>>new Promise((resolve, reject) => {
    window["MacroWidgetPromiseResolve"] = resolve;
});
window["PlominoMacrosPromise"] = <Promise<any>>new Promise((resolve, reject) => {
    window["PlominoMacrosPromiseResolve"] = resolve;
});
window["registryPromise"] = <Promise<any>>new Promise((resolve, reject) => {
    window["registryPromiseResolve"] = resolve;
});
window["materialPromise"] = <Promise<any>>new Promise((resolve, reject) => {
