...
@Component({
    ...
    directives: [TinyMCEComponent, PlominoWorkflowComponent, PlominoViewEditorComponent, ACEEditorComponent],
})
export class PlominoTabComponent implements OnChanges {
    ...
    constructor(private zone: NgZone, private tabsManagerService: PlominoTabsManagerService) {}
