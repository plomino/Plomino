...
EXCLUDED_HTML = [
  {'tags': ('center','tt','big','small','u','s','strike','basefont','font',),
   'attributes':(),
   'keep': 1 },
...
STYLE_WHITELIST = ['text-align', 'list-style-type', 'float', 'plominoFieldClass', 'plominoActionClass', 'plominoHidewhenClass']
