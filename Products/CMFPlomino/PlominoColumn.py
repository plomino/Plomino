...
schema = Schema((
    ...
    StringField(
        ...
        widget=StringField._properties['widget'](
            ...
            label_msgid=_('CMFPlomino_label_column_id'),
            description_msgid=_('CMFPlomino_help_column_id'),
...
#            i18n_domain='CMFPlomino',
    ...
    TextField(
        ...
        widget=TextAreaWidget(
            ...
            label_msgid=_('CMFPlomino_label_ColumnFormula'),
            description_msgid=_('CMFPlomino_help_ColumnFormula'),
            i18n_domain='CMFPlomino',
        ),
    ),
#    IntegerField(
...
#    ),
    BooleanField(
        ...
        widget=BooleanField._properties['widget'](
            label="Hidden column",
            label_msgid=_('CMFPlomino_label_HiddenColumn'),
            i18n_domain='CMFPlomino',
        ),
    ),
    BooleanField(
        ...
        widget=BooleanField._properties['widget'](
            ...
            label_msgid=_('CMFPlomino_label_DisplaySum'),
            i18n_domain='CMFPlomino',
        ),
    ),
),
