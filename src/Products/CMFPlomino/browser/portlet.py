...
class Renderer(base.Renderer):
    ...
    render = ViewPageTemplateFile('templates/design_portlet.pt')
...
class ElementPortletRenderer(base.Renderer):
    ...
    render = ViewPageTemplateFile('templates/element_portlet.pt')
...
class ElementPortletAddForm(base.AddForm):
    """Creates a portlet used to display a Plomino element."""
