...
Get item or parent group height
  [Arguments]    ${item_id}
  ...
  ${UNUSED}  ${item_height}=  Get Element Size  xpath=//${item_xpath}
  Run keyword if  ${item_group_count} > 0  ${item_height}=  Get Element Size  xpath=//${item_group_xpath}

  Return from keyword  ${item_height}